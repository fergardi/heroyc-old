  ...
  en: {
    ...
    alert: {
      ...
      battle: {
        ...
        loot: {
          spell: 'You learned <span class="label label-{class}">{spell}</span>',
          recipe: 'You obtained a recipe for <span class="label label-{class}">{recipe}</span>',
          resource: 'You farmed <span class="label label-{class}">{resource}</span>',
          item: 'You looted <span class="label label-{class}">{item}</span>',
          skill: 'You adquired <span class="label label-{class}">{skill}</span>',
        ...
        magic: '<strong>{attacker}</strong> casts <span class="label label-{class}">{spell}</span> to <strong>{defender}</strong> and removes <span class="label label-danger">{damage} vitality</span>',
        heal: '<strong>{attacker}</strong> casts <span class="label label-{class}">{spell}</span> and heals <span class="label label-danger">{heal} vitality</span>',
        buff: '<strong>{attacker}</strong> casts <span class="label label-{class}">{skill}</span>',
      ...
      inventory: {
        equip: 'You equiped <span class="label label-{class}">{item}</span>',
      },
      city: {
        buy: 'You spent <span class="label label-warning">{gold} gold</span> to buy <span class="label label-{class}">{name}</span>',
      },
      market: {
        buy: 'You spent <span class="label label-info">{platinum} platinum</span> to buy <span class="label label-{class}">{name}</span>',
        paypal: 'You bought the <span class="label label-{class}">{name}</span> pack, thanks for your support!',
        error: 'An error ocurred',
      },
      inn: {
        accept: 'You accepted the quest <span class="label label-{class}">{name}</span>',
      },
      forge: {
  ...
  es: {
    ...
    alert: {
      ...
      battle: {
        ...
        loot: {
          spell: 'Has aprendido <span class="label label-{class}">{spell}</span>',
          recipe: 'Has obtenido la receta para <span class="label label-{class}">{recipe}</span>',
          resource: 'Has encontrado <span class="label label-{class}">{resource}</span>',
          item: 'Has obtenido <span class="label label-{class}">{item}</span>',
          skill: 'Has adquirido <span class="label label-{class}">{skill}</span>',
        ...
        magic: '<strong>{attacker}</strong> lanza <span class="label label-{class}">{spell}</span> a <strong>{defender}</strong> y quita <span class="label label-danger">{damage} vitalidad</span>',
        heal: '<strong>{attacker}</strong> lanza <span class="label label-{class}">{spell}</span> y se cura <span class="label label-danger">{heal} vitalidad</span>',
        buff: '<strong>{attacker}</strong> se lanza <span class="label label-{class}">{skill}</span>',
      ...
      inventory: {
        equip: 'Te has equipado con <span class="label label-{class}">{item}</span>',
      },
      city: {
        buy: 'Has gastado <span class="label label-warning">{gold} oro</span> en comprar <span class="label label-{class}">{name}</span>',
      },
      market: {
        buy: 'Has gastado <span class="label label-info">{platinum} platino</span> en comprar <span class="label label-{class}">{name}</span>',
        paypal: 'Has comprado el pack <span class="label label-{class}">{name}</span>, gracias por tu soporte!',
        error: 'Ha ocurrido un error',
      },
      inn: {
        accept: 'Has aceptado la mision <span class="label label-{class}">{name}</span>',
      },
      forge: {
